...
SignalR-Swift is a client library for iOS and Mac OS X based on https://github.com/DyKnow/SignalR-ObjC by DyKnow.  It's built on top of [AlamoFire](https://github.com/Alamofire/Alamofire) and [SwiftWebSocket](https://github.com/tidwall/SwiftWebSocket).
...
SignalR-Swift is available under the MIT license. See the [LICENSE](https://github.com/DyKnow/SignalR-ObjC/blob/master/LICENSE.md) file for more info.<br/>
